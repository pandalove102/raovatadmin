                ...
                <form class="m-t" role="form" action="" method="post" id="form-users">
                    ...
                    <input type="hidden" name="id_user" id="id_user" value="<?=(isset($group)) ? $group->id : ''?>">
                     <div class="form-group"><label class="col-sm-2 control-label">Mã nhóm</label>
                        <div class="col-sm-9">
                           <div class="relative">
                              <input type="text" class="form-control area-input" <?=$this->uri == 'edit'?'disabled':'' ?> rows="1" required="" placeholder="Mã nhóm"  name="group_id" id="group_id" data-error="Nhập mã nhóm" data-error-1="Mã nhóm đã tồn tại!" data-url="<?=base_url('group/check_groupid')?>" value="<?=(isset($group)) ? $group->group_id : ''?>">
                           </div>
