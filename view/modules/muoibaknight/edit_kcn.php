                              ...
                              <div id="tab-1" class="tab-pane active">
                                 <div class="panel-body">
                                    <fieldset class="form-horizontal">
                                       ...
                                       <div class="form-group">
                                          <label class="col-sm-2 control-label">Sản phẩm hiển thị(Chọn 4 tới 8):</label>
                                          <div class="col-sm-10">
                                             <select multiple size="10" class="form-control " name="<?=$listproland->name.'-'.$listproland->id?>[]">
												<?php 
												$isselect = explode(',',$listproland->value);
												foreach($pros as $p){
