                              ...
                              <div id="tab-1" class="tab-pane active">
                                 <div class="panel-body">
                                    <fieldset class="form-horizontal">
                                       ...
                                       <div class="form-group">
                                          <label class="col-sm-2 control-label">Sản phẩm hiển thị(Chọn 2 tới 4):</label>
                                          <div class="col-sm-10">
                                             <select multiple size="10" class="form-control " name="<?=$productland->name.'-'.$productland->id?>[]">
												<?php 
												$isselect = explode(',',$productland->value);
												foreach($pros as $p){
													echo '<option '.(in_array($p->id,$isselect)?'selected':'').' value="'.$p->id.'">'.$p->name.'</option>';
												}
												?>
											 </select>
                                          </div>
