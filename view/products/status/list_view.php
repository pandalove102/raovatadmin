                  ...
                  <table class="table table-striped table-bordered table-hover ">
                     <thead>
                        <tr role="row">
                           ...
                           <th  rowspan="1" colspan="1" aria-label="Full Name: activate to sort column ascending"` style="width: 218px;">Trạng Thái</th>
                           <th  style="width: 196px;">Ngày tạo</th>
                           <th  style="width: 196px;">Ngày cập nhật</th>
