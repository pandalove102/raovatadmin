                                 ...
                                 <div class="panel-body">
                                    <fieldset class="form-horizontal">
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10"><input type="text" required="" placeholder="tên bài viết" onchange="stralias('name','alias')" class="form-control area-input" name="name" data-error="Nhập tên sản phẩm" data-error-1="Tên sản phẩm đã tồn tại!" data-url="<?=base_url('news/api_check_news')?>" value="<?=(isset($news)) ? $news->name : ''?>"></div>
                                       </div>
                                       <div class="form-group">
