               ...
               <form class="m-t" role="form" action="" method="post" >           
                  <div class="wrapper wrapper-content animated fadeInRight ecommerce">
                    <div class="col-sm-9 col-sm-offset-8">
                        <a class="btn btn-white" type="text" href="<?=base_url('footerlink');?>">Cancel</a>
                                 ...
                                 <div class="panel-body">
                                    <fieldset class="form-horizontal">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-sm-10">
                                             <textarea type="text" required=""  placeholder="<?=$content->description?>" class="form-control area-input" name="<?=$content->name.'-'.$content->id?>" id="content"><?=$content->value?></textarea>
                                          </div>
                                       </div> 
                                    </fieldset>
                                 </div>
